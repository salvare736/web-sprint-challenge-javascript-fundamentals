...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      return bothNames.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    });
    return bothNames;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseList = array.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const endangeredList = array.filter(function(item){
